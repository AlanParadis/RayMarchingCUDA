...
inline __host__ __device__ int2 make_int2(int a) {
    return make_int2(a, a);
}

inline __host__ __device__ int3 make_int3(int a) {
    return make_int3(a, a, a);
}

inline __host__ __device__ int4 make_int4(int a) {
    return make_int4(a, a, a, a);
}

inline __host__ __device__ float2 make_float2(float a) {
...
inline __host__ __device__ float3 make_float3(float2 u, float a) {
    return make_float3(u.x, u.y, a);
}
...
inline __host__ __device__ double2 make_double2(double a) {
...
inline __host__ __device__ double4 make_double4(double a) {
...
inline __host__ __device__ int2 operator*(int a, int2 b) {
    return make_int2(a*b.x, a*b.y);
}

inline __host__ __device__ int3 operator*(int a, int3 b) {
    return make_int3(a*b.x, a*b.y, a*b.z);
}

inline __host__ __device__ int4 operator*(int a, int4 b) {
...
inline __host__ __device__ double2 operator*(double a, double2 b) {
...
inline __host__ __device__ double4 operator*(double a, double4 b) {
...
inline __host__ __device__ float3 cross(float4 a, float4 b) {
    return make_float3(a.y*b.z-a.z*b.y, a.z*b.x-a.x*b.z, a.x*b.y-a.y*b.x);
}
...
inline __host__ __device__ double3 cross(double4 a, double4 b) {
    return make_double3(a.y*b.z-a.z*b.y, a.z*b.x-a.x*b.z, a.x*b.y-a.y*b.x);
}
...
inline __host__ __device__ double2 normalize(double2 a) {
...
inline __host__ __device__ double4 normalize(double4 a) {
...
inline __host__ __device__ float3 trimTo3(float4 v) {
    return make_float3(v.x, v.y, v.z);
}

inline __host__ __device__ double3 trimTo3(double4 v) {
